...
| HTTP Method | Endpoint                                   | Description                                      | New    | Changed | Deleted | Deprecated | Compatability | Notes |
|-------------|--------------------------------------------|--------------------------------------------------|--------|---------|---------|------------|---------------|-------|
| POST        | /v1/organizations                          | Create an organization                           | 0.19.0 |         |         |            | None          |       |
| GET         | /v1/organizations                          | Fetch all organizations                          | 0.19.0 |         |         |            | None          |       |
| PATCH       | /v1/organizations                          | Rename organization name                         | 0.19.0 |         |         |            | None          |       |
| GET         | /v1/organizations/me                       | Fetch current organization details               | 0.19.0 |         |         |            | None          |       |
| DELETE      | /v1/organizations/members/{memberId}       | Remove a member from organization using memberId | 0.19.0 |         |         |            | None          |       |
| PUT         | /v1/organizations/members/{memberId}/roles | Update a member role to admin                    | 0.19.0 |         |         |            | None          |       |
| GET         | /v1/organizations/members                  | Fetch all members of current organizations       | 0.19.0 |         |         |            | None          |       |
| PUT         | /v1/organizations/branding                 | Update organization branding details             | 0.19.0 |         |         |            | None          |       |
