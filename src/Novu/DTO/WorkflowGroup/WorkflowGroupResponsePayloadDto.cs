...
{
    [JsonProperty("data")] public WorkflowGroupResponsePayloadDto PayloadDto { get; set; }
}

public class WorkflowGroupBulkResponseDto
{
    [JsonProperty("data")] public List<WorkflowGroupResponsePayloadDto> PayloadDtos { get; set; }
}