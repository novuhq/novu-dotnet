...
namespace Novu.Interfaces
{
    public interface ITopicClient
    {
        ...
        /// </returns>
        Task<TopicCreateResponseDto> CreateTopicAsync(TopicCreateDto dto);
        ...
        /// </returns>
        Task<PaginatedResponseDto<TopicDto>> GetTopicsAsync(int page = 0);
        ...
        /// </param>
        /// <returns></returns>
        Task<TopicResponseDto> GetTopicAsync(string topicKey);
        ...
        /// </returns>
        Task<TopicSubscriberAdditionResponseDto>
        ...
        /// <returns></returns>
        Task<TopicSubscriberDto> VerifySubscriberAsync(string topicKey, string subscriberId);
        ...
        /// <returns></returns>
        Task RemoveSubscriberAsync(string topicKey, TopicSubscriberUpdateDto subscriberKey);
        ...
        /// </param>
        /// <returns></returns>
        Task DeleteTopicAsync(string topicKey);
        ...
        /// </returns>
        Task<TopicResponseDto> RenameTopicAsync(string topicKey, string newTopicName);
    }
}